...
from data.models import GuName, Rainfall, SewerPipe
...
def create_guname():
    ...
    guname_list = [
        ...
        {"GUBN": "11", "GUBN_NAM": "노원"},
        {"GUBN": "12", "GUBN_NAM": "은평"},
        {"GUBN": "13", "GUBN_NAM": "서대문"},
        {"GUBN": "14", "GUBN_NAM": "마포"},
        {"GUBN": "15", "GUBN_NAM": "양천"},
        {"GUBN": "16", "GUBN_NAM": "강서"},
        {"GUBN": "17", "GUBN_NAM": "구로"},
        {"GUBN": "18", "GUBN_NAM": "금천"},
        {"GUBN": "19", "GUBN_NAM": "영등포"},
        {"GUBN": "20", "GUBN_NAM": "동작"},
        {"GUBN": "21", "GUBN_NAM": "관악"},
        {"GUBN": "22", "GUBN_NAM": "서초"},
        {"GUBN": "23", "GUBN_NAM": "강남"},
...
def save_rainfall_data(start, end):
    ...
    for rainfall_list in result_second:
        ...
        Rainfall(
            raingauge_code=RAINGAUGE_CODE,
            raingauge_name=RAINGAUGE_NAME,
            gu_code=GU_CODE,
            gu_name=GU_NAME,
